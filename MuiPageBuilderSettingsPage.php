...
<?php
  ...
  public function pageInit(): void
  {
    ...
    add_settings_field(
      ...
      function () {
        printf(
          '<input class="large-text code" type="text" name="%s[username]" value="%s" />',
          self::OPTIONS_ID,
          $this->getOptions()['username'],
        );
      },
      self::PAGE_ID,
      $settings_section_id,
    ...
    add_settings_field(
      ...
      function () {
        printf(
          '<input class="large-text code" type="password" name="%s[password]" value="%s" />',
          self::OPTIONS_ID,
          $this->getOptions()['password'],
        );
      },
      self::PAGE_ID,
      $settings_section_id,
